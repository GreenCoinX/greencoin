...
*Setup instructions for a gitian build of GreenCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the GreenCoin
...
- [Building GreenCoin](#building-greencoin)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-greencoin-host/README.md).
...
git clone https://github.com/greencoin/greencoin
cd greencoin
...
To build GreenCoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/greencoin/greencoin
...
For example:
```bash
URL=https://github.com/laanwj/greencoin.git
...
[greencoin/gitian.sigs](https://github.com/greencoin/gitian.sigs/) repository, or if that's not possible create a pull
