GreenCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/greencoin/files/GreenCoin/greencoin-0.5.4/
...
http://gitorious.org/greencoin/greencoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix GreenCoin-Qt notifications under Growl 1.3.
Increase required age of GreenCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGreenCoin properly when installing GreenCoin-Qt over it. (Windows)
