Download URL: https://sourceforge.net/projects/greencoin/files/GreenCoin/greencoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 XGC fee schedule (users still pay 0.01 XGC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #greencoin00 - #greencoin99
