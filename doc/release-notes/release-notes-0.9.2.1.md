GreenCoin Core version 0.9.2.1 is now available from:

  https://greencoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XGC to 0.01 XGC
...
- Fix "Start greencoin on system login"
