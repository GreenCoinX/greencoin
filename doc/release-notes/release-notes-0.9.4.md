GreenCoin Core version 0.9.4 is now available from:

  https://greencoin.org/bin/0.9.4/
...
this update is incompatible with the GreenCoin system and could lead to consensus
forks.

GreenCoin Core released binaries from https://greencoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~greencoin/+archive/ubuntu/greencoin
- A third-party or self-compiled GreenCoin Core

upgrade to GreenCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
