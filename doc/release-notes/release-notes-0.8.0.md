GreenCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/greencoin/files/GreenCoin/greencoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the GreenCoin
...
New/changed settings (command-line or greencoin.conf file)
--------------------------------------------------------
