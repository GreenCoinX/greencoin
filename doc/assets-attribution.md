The following is a list of assets used in the greencoin source and their proper attribution.
...
* License: MIT
* Site: [https://greencointalk.org/index.php?topic=15276.0](https://greencointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original greencoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/greencoin.icns, src/qt/res/src/greencoin.svg,
	src/qt/res/src/greencoin.ico, src/qt/res/src/greencoin.png,
	src/qt/res/src/greencoin_testnet.png, docs/greencoin_logo_doxygen.png,
