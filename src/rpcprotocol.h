...
#ifndef GREENCOIN_RPCPROTOCOL_H
#define GREENCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! GreenCoin is not connected
