...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGreenCoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GreenCoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGreenCoinURI(info));
}
