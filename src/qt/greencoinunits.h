...
#ifndef GREENCOIN_QT_GREENCOINUNITS_H
#define GREENCOIN_QT_GREENCOINUNITS_H
...
/** GreenCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GreenCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GreenCoinUnits(QObject *parent);

    /** GreenCoin units.
      @note Source: https://en.greencoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XGC,
...
typedef GreenCoinUnits::Unit GreenCoinUnit;

#endif // GREENCOIN_QT_GREENCOINUNITS_H
