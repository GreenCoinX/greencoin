...
###   This script attempts to download the signature file SHA256SUMS.asc from greencoin.org
...
WORKINGDIR="/tmp/greencoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://greencoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://greencoin.org/bin/"
VERSIONPREFIX="greencoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'greencoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[greencoin-]<version>-[rc[0-9]] (example: greencoin-0.9.2-rc1)"
   echo "wget output:"
